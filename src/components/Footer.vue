<template>
    <div class="footer">
        ...
        <div class="footerItem footerMiddle">
            <div>
                <span class="footerMiddleHeaderLabel footerMiddleHeaderLabelFirst">
                    Explore
                </span>
                <span class="footerMiddleHeaderLabel">
                    SmartBear
                </span>
                <span class="footerMiddleHeaderLabel">
                    Tools
            ...
            <div class="footerMiddleFooter">
                ...
                <div class="footerMiddleFooterItem">
                    <span class="footerMiddleElement footerMiddleFooterItemLabel">
                        |
                    </span>
                </div>
                <div class="footerMiddleFooterItem">
                ...
                <div class="footerMiddleFooterItem">
                    <span class="footerMiddleElement footerMiddleFooterItemLabel footerMiddleFooterItemHeader  footerMiddleItemHeader">
                        Partners
                    </span>
                </div>
            </div>
...
<style scoped>
    ...
    .footerTop {
        ...
        background-image: url('https://static1.smartbear.co/swagger/media/images/backgrounds/photos/sw-ws-bgphoto5.png');    
    }
    ...
    .footerMiddleHeaderLabelFirst {
        text-decoration: underline;
        text-underline-offset: 25px;
        text-decoration-color: rgb(200, 150, 0);
    }
    ...
    .footerMiddleFooterItem {
        margin: 0px 10px;
        display: flex;
        align-items: center;
    }

    .footerMiddleFooterItemLabel {
        color: rgb(255, 255, 255);
        font-size: 18px;
    }
